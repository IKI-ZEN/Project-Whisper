...
export interface SandboxConfig {
  ...
  guardOutput?: 'off' | 'audit' | 'block' | 'redact'   // policy applied to model replies (default 'audit')
  redactPiiOutput?: boolean   // when true, redact PII from model replies (default false; off for research)
  ragEnabled?: boolean
  ...
  envModels?: string[]       // ordered model list for lab compare mode (1–MAX_ENV_MODELS)
  whispererFeatures?: string[] // active Whisperer analysis features for this environment
}
...
export interface CreateSandboxRequest {
  ...
  maxTokens: number
  guardMode?: 'strict' | 'audit' | 'off'
  guardOutput?: 'off' | 'audit' | 'block' | 'redact'
  redactPiiOutput?: boolean
  ragEnabled?: boolean
  appHtml?: string
}
...
export type VibeMode = 'app' | 'environment' | 'dashboard'
