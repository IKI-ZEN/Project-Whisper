...
| `/environments` | Environments Gallery | Browse, fork, and open AI-configured chat workspaces |
| `/env/:id` | Environment Chat | Per-environment compare mode (up to 4 models side-by-side) |
